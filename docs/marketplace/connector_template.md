...
- Стандартная поддержка: включена во все тарифные планы
- Расширенная поддержка: доступна за дополнительную плату (50 USD/месяц)
- Премиум поддержка: доступна за дополнительную плату (100 USD/месяц)
```
