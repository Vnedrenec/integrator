...
2. **Платежные шлюзы** - интеграции с международными платежными системами (Stripe, PayPal) для обработки платежей
...
BPM Centr использует современные международные платежные системы для обработки платежей:
